...
replacement method exists) \jl{I suggest to remove this sentence.  We have
  already made it clear that backward compatibility is what is
  wanted.}. Given these apps, \toolname\ finds changes that add the
