...
its replacement method \texttt{getHour()}. Given this example, one\lx{should this "one" be AppEvolve, or it really means someone?} can
...
+ }
\end{lstlisting}
\lx{better to use different symbols to differentiate the \$T on the left and right of '='?}
