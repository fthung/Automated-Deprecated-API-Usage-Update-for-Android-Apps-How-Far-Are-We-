...
Note that AppEvolve can only perform API usage learning and update one mapping at a time. Thus, even though {\tt getCurrentMinute} is also a deprecated method,  AppEvolve does not learn how to update it together with {\tt getCurrentMinute} since it is in a different mapping.
