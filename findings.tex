...
\vspace{0.25\baselineskip}\noindent Note that the categories {\em edits beyond method boundaries} and {\em no examples} are from AppEvolve failure updates. The other categories are uncovered from our  dataset.
