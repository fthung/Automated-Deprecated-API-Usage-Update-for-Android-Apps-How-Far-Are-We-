...
compiler intermediate representations \cite{dragon} \jl{I don't know why we
did this.  Did we look at the examples?  Did we look at the target apps
that were successfully updated?  Did we just try to make the code
simpler?}\ft{We look at the target apps that were successfully updated and try to make the code simpler}.  The right side of Table~\ref{tab:mitigatesucc} shows a diff
