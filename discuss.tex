...
There are 8 failed updates \jl{in our dataset?} where our mitigation
...
We modified the code on the left hand side of Listing 8 in
...
our data set, where we obtained an accuracy \jl{right word?} of
\jl{what}\%, and the results reported by the authors of AppEvolve, who
obtained an accuracy of \jl{what}\%, even though our dataset was
...
as \jl{getCurrentHour()} (e.g., Listing 3), that in our dataset are often
...
original on GitHub in the file \jl{fill in}.  Again, we find that in the
