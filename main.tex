...
the number of experiments reported is moderate \jl{Do we like this
  sentence?  I felt that some transition was needed.}. In this work, we
...
refactoring of the app code to better resemble the code in the examples,
which usually involves assigning a target API method invocation and
arguments of the target API method into variables \jl{I suggest to drop
  ...
  can be a separate senetnce.}.  Indeed, we have also seen such
