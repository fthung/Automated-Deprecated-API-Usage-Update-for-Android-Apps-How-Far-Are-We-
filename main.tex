...
the app code to better resemble the code in the examples, which usually involves assigning a target API method invocation and arguments of the target API method into variables.
