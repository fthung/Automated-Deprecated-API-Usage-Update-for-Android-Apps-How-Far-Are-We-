...
\author{
	...
	\IEEEauthorblockN{Ferdian Thung$^1$, Stefanus Agus Haryono$^1$, Lucas Serrano$^2$, Julia Lawall$^2$, David Lo$^1$, and Lingxiao Jiang$^1$}
\author{
	\IEEEauthorblockA{
\IEEEauthorblockN{
		$^1$Singapore Management University, Singapore\\
Ferdian Thung\IEEEauthorrefmark{1},
		$^2$Sorbonne Université/Inria/LIP6, France\\
Stefanus A. Haryono\IEEEauthorrefmark{1},
		Email: \{ferdianthung, stefanusah, davidlo, lxjiang\}@smu.edu.sg, \{Julia.Lawall, Lucas.Serrano\}@lip6.fr
Lucas Serrano\IEEEauthorrefmark{2},
	}
Julia Lawall\IEEEauthorrefmark{2}, 
}
David Lo\IEEEauthorrefmark{1} and

Lingxiao Jiang\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}School of Information Systems\\
...
Email: \{julia.lawall,lucas.serrano\}@lip6.fr}
}
...
the app code to better resemble the code in the examples, which \jl{David: say something about the manual study of data}
